 ...
 */
function una_customize_register( $wp_customize )
{
    ...
    $wp_customize->selective_refresh->add_partial( 'blogname', array(
        ...
        'render_callback' => 'una_customize_partial_blogname',
    ) );

    $wp_customize->selective_refresh->add_partial( 'blogdescription', array(
        'selector' => '.site-description',
        'render_callback' => 'una_customize_partial_blogdescription',
    ) );
...
//        'title' => __( 'Theme Options', 'una' ),
//        'priority' => 130, // Before Additional CSS.
//    ) );
//
//    $wp_customize->add_section( 'post_types', array(
//        'title' => __( 'Post Type Archives', 'una' ),
//        'priority' => 130, // Before Additional CSS.
//    ) );
...
//            'type' => 'radio',
//            'description' => __('You can make your own layout in header.php and ignore all this.', 'una'),
//            'choices' => array(
//                'yes' => 'yes',
//                'no' => 'no'
//            )
...
//        array(
//            'label' => __( 'Contain the site top items', 'una' ),
//            'section' => 'theme_options',
//            'type' => 'select',
//            'choices' => array(
//                'container' => 'contained',
...
//            ),
//            'description' => __('You can set contained size via $container in scss', 'una')
//        ) );
...
//            'section' => 'theme_options',
//            'type' => 'select',
//            'description' => __('You can make your own layout in php in header.php and ignore presets and manual settings.', 'una'),
//            'choices' => array(
//                'logo-left' => 'logo-left',
...
add_action( 'customize_register', 'una_customize_register' );
 ...
 *
 * @since Ignition 1.0
 * @see una_customize_register()
 *
 * @return void
 */
function una_customize_partial_blogname()
{
    bloginfo( 'name' );
}
 ...
 * @return void
 */
function una_customize_partial_blogdescription()
{
 ...
 */
function una_customize_preview_js()
{
    wp_enqueue_script( 'una-customize-preview', get_theme_file_uri( '/assets/js/customize-preview.js'
    ), array('jquery', 'customize-preview'), '1.0', true );
}

add_action( 'customize_preview_init', 'una_customize_preview_js' );

/**
 * Load dynamic logic for the customizer controls area.
 */
function una_panels_js()
{
    wp_enqueue_script( 'una-customize-controls', get_theme_file_uri( '/assets/js/customize-controls.js' ), array(), '1.0', true );
}
//add_action( 'customize_controls_enqueue_scripts', 'una_panels_js' );
