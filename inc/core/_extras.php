 ...
 * @return void
 */
function una_output_inline_svg( $html ) {
...
add_filter( 'get_custom_logo', 'una_output_inline_svg' );
 ...
 *
 */
function una_resource_hints( $urls, $relation_type ) {
	if ( wp_style_is( 'una-fonts', 'queue' ) && 'preconnect' === $relation_type ) {
		$urls[] = array(
...
add_filter( 'wp_resource_hints', 'una_resource_hints', 10, 2 );
