<?php
	...
	function two_columns_cta_block_register_block() {

		acf_register_block_type( array(
			'name'            => 'two-cols-cta',
			'title'           => __( 'Two Columns CTA' ),
			'description'     => __( 'Display a block with both with 2 columns with simple CTAs' ),
			'render_template' => 'src/blocks/two-columns-cta/two-columns-cta.php',
			'category'        => 'una-blocks',
	...
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'two_columns_cta_block_register_block' );
	}
