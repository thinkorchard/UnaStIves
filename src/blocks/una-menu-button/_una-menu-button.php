<?php
	...
	function una_menu_button_register_block() {

		acf_register_block_type( array(
			'name'            => 'una-menu-button',
			'title'           => __( 'UNA Menu Button' ),
			'description'     => __( 'shows a custom button for menus.' ),
			'render_template' => 'src/blocks/una-menu-button/una-menu-button.php',
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'una_menu_button_register_block' );
	}
