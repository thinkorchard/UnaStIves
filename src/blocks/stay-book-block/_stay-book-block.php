<?php
	...
	function stay_book_block_register_block() {

		acf_register_block_type( array(
			'name'            => 'stay-book-block',
			'title'           => __( 'Stay Book form' ),
			'description'     => __( 'Display a simple form for booking villas' ),
			'render_template' => 'src/blocks/stay-book-block/stay-book-block.php',
			'category'        => 'una-blocks',
	...
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'stay_book_block_register_block' );
	}
