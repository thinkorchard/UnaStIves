<?php
	...
	function section_block_register_block() {

		acf_register_block_type( array(
			'name'            => 'section-block',
			'title'           => __( 'Section Block' ),
			'description'     => __( 'Display a section to contain other blocks' ),
			'render_template' => 'src/blocks/section-block/section-block.php',
			'category'        => 'una-blocks',
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'section_block_register_block' );
	}
