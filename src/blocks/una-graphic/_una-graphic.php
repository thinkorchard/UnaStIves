<?php
	...
	function una_graphic_register_block() {

		acf_register_block_type( array(
			'name'            => 'una-graphic',
			'title'           => __( 'UNA Graphic' ),
			'description'     => __( 'shows a custom graphic for UNA.' ),
			'render_template' => 'src/blocks/una-graphic/una-graphic.php',
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'una_graphic_register_block' );
	}
