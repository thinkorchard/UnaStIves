<?php
	...
	function title_paragraph_block_register_block() {

		acf_register_block_type( array(
			'name'            => 'title-paragraph-block',
			'title'           => __( 'Title & Paragraph Block' ),
			'description'     => __( 'Display a block with both Title and Paragraph' ),
			'render_template' => 'src/blocks/title-paragraph-block/title-paragraph-block.php',
			'category'        => 'una-blocks',
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'title_paragraph_block_register_block' );
	}
