<?php
	...
	function una_villa_slider_block_register_block() {

		acf_register_block_type( array(
			'name'            => 'una-villa-slider-block',
			'title'           => __( 'UNA Villa Slider Block' ),
			'description'     => __( 'Display a block with a slider with configurable options for display' ),
			'render_template' => 'src/blocks/una-villa-slider-block/una-villa-slider-block.php',
			'category'        => 'una-blocks',
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'una_villa_slider_block_register_block' );
	}
