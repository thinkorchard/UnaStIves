<?php
	...
	function image_grid_block_register_block() {

		acf_register_block_type( array(
			'name'            => 'image_grid-block',
			'title'           => __( 'Image Grid Block' ),
			'description'     => __( 'Display a image grid with links' ),
			'render_template' => 'src/blocks/image-grid-block/image-grid-block.php',
			'category'        => 'una-blocks',
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'image_grid_block_register_block' );
	}
