<?php
	...
	function una_brochure_button_register_block() {

		acf_register_block_type( array(
			'name'            => 'una-brochure-button',
			'title'           => __( 'UNA Brochure Button' ),
			'description'     => __( 'shows a custom button for linking to brochures etc.' ),
			'render_template' => 'src/blocks/una-brochure-button/una-brochure-button.php',
			'category'        => 'orchard-blocks',
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'una_brochure_button_register_block' );
	}
