<?php
	...
	function title_sub_title_block_register_block() {

		acf_register_block_type( array(
			'name'            => 'title-sub-title-block',
			'title'           => __( 'Title/SubTitle Block' ),
			'description'     => __( 'Display a block with both Title and SubTitle' ),
			'render_template' => 'src/blocks/title-sub-title-block/title-sub-title-block.php',
			'category'        => 'una-blocks',
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'title_sub_title_block_register_block' );
	}
