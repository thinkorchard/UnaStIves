<?php
	...
	function campaign_monitor_register_block() {

		acf_register_block_type( array(
			'name'            => 'campaign-monitor',
			'title'           => __( 'Campaign Monitor' ),
			'description'     => __( 'Display a block with Campaign Monitor Signup form' ),
			'render_template' => 'src/blocks/campaign-monitor/campaign-monitor.php',
			'category'        => 'una-blocks',
			...
			'keywords'        => array( 'form', 'signup', 'campaign monitor' ),
			'supports'        => array(
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'campaign_monitor_register_block' );
	}
