<?php
	...
	function una_button_register_block() {

		acf_register_block_type( array(
			'name'            => 'una-button',
			'title'           => __( 'UNA Button' ),
			'description'     => __( 'shows a custom button for call to action etc.' ),
			'render_template' => 'src/blocks/una-button/una-button.php',
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'una_button_register_block' );
	}
