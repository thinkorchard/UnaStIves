<?php
	...
	function una_menu_container_block_register_block() {

		acf_register_block_type( array(
			'name'            => 'narrow-section-block',
			'title'           => __( 'Narrow Section Block' ),
			'description'     => __( 'Display a narrow section to contain other blocks' ),
			'render_template' => 'src/blocks/una-menu-container-block/una-menu-container-block.php',
			'category'        => 'una-blocks',
...
// Check if function exists and hook into setup and adds all blocks.
	if ( function_exists( 'acf_register_block_type' ) ) {
		add_action( 'acf/init', 'una_menu_container_block_register_block' );
	}
